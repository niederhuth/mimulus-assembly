...
#Set variables
target_fa= #target genome fasta to map gff files to, if left blank, look in current directory
target_gff= #gff file for target genome, only necessary if gffcompare=TRUE

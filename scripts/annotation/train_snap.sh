...
maker2zff -x 0.1
/data/run/miughetta/Stevia_rebaudiana/maker_1/Stevia_V2.3.maker.output/Stevia_V2.3.all.gff

 fathom -categorize 1000 genome.ann genome.dna
fathom -export 1000 -plus uni.ann uni.dna
forge export.ann export.dna
hmm-assembler.pl stevia_snap /data/run/miughetta/Stevia_rebaudiana/trainingSNAP >
/data/run/miughetta/Stevia_rebaudiana/trainingSNAP/steviaSNAP.hmm

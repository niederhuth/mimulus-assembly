...
threads=50
fast5_dir="fast5"
model="$(pwd | sed s/data.*/scripts/)/methylation/ont_mdels/model.dp2.CNN.arabnrice2-1_120m_R9.4plus_tem.bn13_sn16.both_bilstm.epoch6.ckpt" #Path to model for deepsignal-plant
